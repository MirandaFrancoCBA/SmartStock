...
# Local dev servers may select a free ephemeral port. Allow localhost on any
# port only while DEBUG is enabled; production remains restricted to the
# explicit origins configured above.
